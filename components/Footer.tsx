        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-white">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              >
                <Image
                  src="/doctoralia-favicon.png" // Ruta al ícono en la carpeta public
                  alt="Doctoralia"
                  width={24} // Ancho del ícono
                  height={24} // Alto del ícono
                  className="w-6 h-6 filter brightness-0 invert hover:brightness-100 hover:invert-0" // Estilos para cambiar el color
                />
              </a>
            </div>
          </div>
